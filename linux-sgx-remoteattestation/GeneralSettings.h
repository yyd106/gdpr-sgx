...
namespace Settings {
	...
	static string server_crt = "../cert/real/server.crt"; //certificate for the HTTPS connection between the SP and the App
	static string server_key = "../cert/real/server.key"; //private key for the HTTPS connection
