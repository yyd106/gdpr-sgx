...
function findKeys(ecPublicKey = {}) {
  ...
  MY_PRIVATE_KEY = MY_PRIVATE_KEY ? MY_PRIVATE_KEY : myPrivateKey;

  // typeof MY_PUBLIC_KEY: Object
  MY_PUBLIC_KEY = MY_PUBLIC_KEY ? MY_PUBLIC_KEY : getMyPublicKey(MY_PRIVATE_KEY);

  // typeof MY_SHARED_KEY: Object
  MY_SHARED_KEY = MY_SHARED_KEY ? MY_SHARED_KEY : getMySharedKey(MY_PRIVATE_KEY, ecPublicKey);
